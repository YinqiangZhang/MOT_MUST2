...
# ------------------------------------------------------------------------ #
# Modified for the Zhejiang MOT Challenge
# ------------------------------------------------------------------------ #
...
# the occlusion threshold out of video frame 
__C.PARAMS.EXIT_THRESHOLD = 0.3

# tracking score threshold (default 0.9, can be changed with .yaml file)
__C.PARAMS.TRACKING_SCORE_THRESHOLD = 0.5

# overlap threshold for tracking bbox and detection
__C.PARAMS.OVERLAP_THRESHOLD = 0.8

# distance threshold
__C.PARAMS.DISTANCE_THRESHOLD = 2

# aspect ratio threshold
__C.PARAMS.ASPECT_RATIO_THRESHOLD = 0.6

# termination threshold
__C.PARAMS.TERMINATION_THRESHOLD = 2

# detection overlap threshold 
__C.PARAMS.DET_OVERLAP_THRESHOLD = 0.5

# 
__C.PARAMS.ASSOCIATION_SCORE_THRESHOLD = 0.6