...
if __name__ == '__main__':
    ...
    folder = "F:/Mingdong/opensource_code/deep_sort_pytorch-master/YOLOv3"
    yolo3 = YOLOv3(folder+"/cfg/yolo_v3.cfg",folder+"/yolov3.weights",folder+"/cfg/coco.names", is_plot=True)
    print("yolo3.size =",yolo3.size)
    import os
    root = "F:/Mingdong/opensource_code/deep_sort_pytorch-master/demo"
    ...
    for filename in files:
        ...
        res = yolo3(img)
        # save results
        cv2.imwrite("F:/Mingdong/opensource_code/deep_sort_pytorch-master/demo_result/{}".format(os.path.basename(filename)),res[:,:,(2,1,0)])
        # imshow
