...
hyp = {'giou': 1.582,  # giou loss gain
       ...
       'lr0': 0.002,  # initial learning rate (SGD=1E-3, Adam=9E-5)
       # 0.002324 original for batch-size 32; I modify it because of limited GPU mem
...
def train():
    ...
    del pg0, pg1   # release the ram utilization
            ...
            if not (opt.notest or (opt.nosave and epoch < 10)) or final_epoch:
                with torch.no_grad():
                    results, maps = test.test(cfg,
                                              ...
                                              save_json=final_epoch and epoch > 0 and 'citypersons.data' in data)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='citypersons/citypersons.data', help='*.data file path')
    ...
    parser.add_argument('--weights', type=str, default='weights/weights/yolov3-spp.weights', help='initial weights')  # i.e. weights/darknet.53.conv.74
